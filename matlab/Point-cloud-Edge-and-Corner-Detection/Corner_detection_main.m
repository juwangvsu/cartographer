%% Read Point cloud
%ptCloud = pcread('/media/mariam/Mariam_Backup/IROS 2018 Dataset/PanelLine
%Dataset/Old dataset/panel_line3.pcd');%'/media/nus/Umer Rasheed 83110809/PanelLine Dataset/panel_line3.pcd')
